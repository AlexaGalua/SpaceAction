...
//    let scoreLabel = SKLabelNode(fontNamed: "Quadaptor")
//    let highScoreLabel = SKLabelNode(fontNamed: "Quadaptor")
...
////        for i in 0...index - 1 {
//        for i in 0...index + 1 {
//            scoreLabel.text = "Score: \(records[i].score)"
////            print("Score: \(String(describing: records[i].score))")
//        }
...
//        highScoreLabel.position = CGPoint(x: self.size.width * 0.5, y: self.size.height * 0.55)
...
//    func clearUserData(){
//        defaults.removeObject(forKey: "highScoreSaved")
//    }
