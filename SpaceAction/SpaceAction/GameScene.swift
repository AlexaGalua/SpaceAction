...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    var newLives = [SKSpriteNode]()
    let newLifeSize = CGSize(width: 60, height: 60)
...
//        static let NewLife: UInt32 = 0b101 //5
        static let NewLife: UInt32 = 0b1000 //8
//        static let EdgeBody: UInt32 = 0b101 //6
   ...
   private var settings = Settings(playerName: nil, spaceshipName: nil, timer: nil)
    ...
    func didBegin(_ contact: SKPhysicsContact) {
        ...
        if body1.categoryBitMask == PhysicsCategory.Player && body2.categoryBitMask == PhysicsCategory.NewLife {
//            increaseLives()
            if body2.node != nil {
                if body2.node!.position.y > self.size.height {
                    return
